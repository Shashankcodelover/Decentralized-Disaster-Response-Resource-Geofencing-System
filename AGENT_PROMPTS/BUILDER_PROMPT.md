...
- Search the web for decentralized disaster response systems,
  geofencing platforms, resource allocation engines, and crisis
  management coordination tools.
- Analyze at least 3–5 competing products (Ushahidi, Sahana, FEMA
  tools, Google Crisis Response, etc.).
- Produce a CHECKLIST of 10–15 actionable improvements with evidence.

STEP 2: DESIGN (Role 2 — UI/UX)
- This tool may be used under real stress — during or right after a
  disaster, by responders and panicked civilians with unreliable
  connectivity. Every screen should assume the user is distracted,
  on a bad connection, and cannot afford to misread something.
...
- Test: geofencing triggers, resource allocation, offline sync,
  concurrent requests, bad network conditions.

STEP 5: SECURE (Role 5 — Security Engineering)
- Pay special attention to location-data handling (geofencing) —
  never leak precise user/victim locations beyond what's needed.
- Consider malicious use: tracking victims rather than helping.
...
Domain: decentralized disaster-response coordination and geofencing
