# DECENTRALIZED DISASTER RESPONSE — DAILY OPERATING DIRECTIVES

## DAILY WORKFLOW — ONE COMPLETE THREE-PHASE CYCLE PER DAY

Every session follows a **SINGLE COMPLETE THREE-PHASE CYCLE** combining the **BUILDER**, **REJECTOR**, and **BUILDER (RESOLVER)** identities in strict sequence. This cycle runs **once per day at 08:00 PM** (or when the daily session is started). The standard is **10X improvement per day**.
...
- **Builder Prompt**: [`AGENT_PROMPTS/BUILDER_PROMPT.md`](file:///d:/users/Shashank%20J/Desktop/my%20stufs/Decentralized-Disaster-Response-Resource-Geofencing-System/AGENT_PROMPTS/BUILDER_PROMPT.md)
- **Rejector Prompt**: [`AGENT_PROMPTS/REJECTOR_PROMPT.md`](file:///d:/users/Shashank%20J/Desktop/my%20stufs/Decentralized-Disaster-Response-Resource-Geofencing-System/AGENT_PROMPTS/REJECTOR_PROMPT.md)
- **Rejection Report**: [`REJECTION_REPORT.md`](file:///d:/users/Shashank%20J/Desktop/my%20stufs/Decentralized-Disaster-Response-Resource-Geofencing-System/REJECTION_REPORT.md)
